        ...
        core_1.Component({
            ...
            animations: [
                ...
                core_1.trigger('visibleTrigger', [
                    core_1.state('visible', core_1.style({ opacity: '1' })),
                    core_1.transition('void => *', [core_1.style({ opacity: '0' }), core_1.animate('200ms 300ms')]),
                    core_1.transition('* => void', [core_1.animate('200ms', core_1.style({ opacity: '0' }))])
                ])
            ]
        }), 
